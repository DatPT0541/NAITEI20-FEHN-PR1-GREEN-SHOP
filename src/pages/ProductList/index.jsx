      ...
      <div className="px-10 md:px-50 flex flex-col md:flex-row text-left pt-10">
        ...
        <div className="w-3/4">
          ...
          <div>
            ...
            {/* Phân trang */}
            {displayedProducts.length > 0 && (
              <div className="flex items-center justify-end space-x-2 mt-6 pt-10 pb-10 md:pt-20 md:pb-20">
                <button
                  className="px-4 py-2 border border-gray-300 rounded-30 hover:bg-gray-100 hidden md:block"
                  onClick={() => goToPage(currentPage - 1)}
                  disabled={currentPage === 1}
                >
                  <div className="">Trang trước</div>
                </button>
