...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-start p-0 mt-20 mb-20s">
        ...
        <div className="text-left grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="block text-gray-700">Địa chỉ email <span className="text-red-500">*</span></label>
                <input
                  type="email"
                  value={email}
              ...
              <div>
                <label className="block text-gray-700">Số ĐT <span className="text-red-500">*</span></label>
                <input
                  type="tel"
                  value={phone}
              ...
              <div>
                <label className="block text-gray-700">Bình luận <span className="text-red-500">*</span></label>
                <textarea
                  value={message}
          ...
          <div className="flex flex-col space-y-3">
            <div className="w-60 h-20 bg-cover bg-center" style={{ backgroundImage: "url('/images/banner2.png')" }}></div>

            <p className="text-gray-400 text-left">
              DKT được thành lập với niềm đam mê và khát vọng thành công trong lĩnh vực Thương mại điện tử. Chúng tôi đã và đang khẳng định được vị trí hàng đầu bằng những sản phẩm.
            </p>
